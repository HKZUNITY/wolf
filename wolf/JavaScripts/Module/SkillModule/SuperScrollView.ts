...
export class UIMultiScroller {
    ...
    */
    constructor(sbox: mw.ScrollBox, sr: mw.Canvas, preafab: mw.TypeName<IItemRender>, maxPerLine: number, leftSpace: number = 30, topSpace: number = 30, cellWidth: number = 150, cellHeight: number = 150, viewCount: number = 5, spacingX: number = 40, spacingY: number = 20) {
        this._sBox = sbox;
        this._scrollRoot = sr;
    ...
    private createItem(i: number) {
        ...
        if (this._unUsedQueue.size() > 0) {
            ...
            if (this._itemPrefab.Gain != null) {
                ...
                itemBase = mw.UIService.create(this._itemPrefab) as any;
            }
