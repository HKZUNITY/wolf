...
import ActionTabItem_Generate from "../../../ui-generate/module/DanMuModule/ActionTabItem_generate";
import DanMuModuleC from "../DanMuModuleC";

export default class ActionTabItem extends ActionTabItem_Generate {
	...
	public setDatas(index: number, name: string): void {
		...
		this.mTabNameTextBlock.text = nameStr[Globals.languageId];
	}
