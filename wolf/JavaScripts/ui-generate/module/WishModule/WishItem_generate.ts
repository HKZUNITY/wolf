 ...
 * AUTHOR: 爱玩游戏的小胖子
 * UI: UI/module/WishModule/WishItem.ui
 * TIME: 2025.10.01-11.57.02
 */
 
@UIBind('UI/module/WishModule/WishItem.ui')
export default class WishItem_Generate extends UIScript {
