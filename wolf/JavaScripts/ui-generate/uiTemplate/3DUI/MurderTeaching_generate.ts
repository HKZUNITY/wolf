 ...
 * AUTHOR: 就要按
 * UI: UI/uiTemplate/3DUI/MurderTeaching.ui
 * TIME: 2023.07.27-15.47.30
 */

 

 @UIBind('UI/uiTemplate/3DUI/MurderTeaching.ui')
 export default class MurderTeaching_Generate extends mw.UIScript {
    ...
    @UIWidgetBind('RootCanvas/mCanvas_Pic/Canvas_4/mText_4')
    public mText_4: mw.TextBlock=undefined;
