 ...
 * AUTHOR: 爱玩游戏的小胖子
 * UI: UI/common/worldUI/DetectiveTeaching.ui
 * TIME: 2025.07.28-23.31.43
 */
 
@UIBind('UI/common/worldUI/DetectiveTeaching.ui')
export default class DetectiveTeaching_Generate extends UIScript {
